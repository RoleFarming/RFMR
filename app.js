...
app.use('/game', express.static(path.join(__dirname, 'public/game'), { maxAge: 31557600000 }));
app.use('/game/2', express.static(path.join(__dirname, 'public/game/2'), { maxAge: 31557600000 }));
